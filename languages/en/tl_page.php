 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_page']['pageImage']			= array('Image for this page', 'Please select an image for this page. If you don\' choose anything, the image of the parent page might be used.');
$GLOBALS['TL_LANG']['tl_page']['pageImageJumpTo']	= array('Image-link for this page', 'You can add a link to another TYPOlight page when clicking on the image.');
